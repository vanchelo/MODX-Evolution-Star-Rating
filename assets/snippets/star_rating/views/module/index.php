...
<div class="container" ng-controller="RatingController as $ctrl">
  <div class="row">
    <div class="col-md-8">
    ...
    <div class="col-md-4 text-right">
      <div class="information">
        <span><b>Всего</b> &middot;
          <span class="label label-success" ng-bind="total"></span></span>
        <span><b>Показано</b> &middot;
          <span class="label label-success" ng-bind="resources.length"></span></span>
      </div>
    </div>
  </div>
  ...
  <table class="table table-striped table-hover table-condensed">
    <thead>
    <tr>
      <th style="width:40px;text-align:center" ng-click="change('id')">
        ID<i ng-class="getSortDir('id')"></i>
      </th>
      <th style="width:280px;text-align:center" ng-click="change('longtitle')">
        Название<i ng-class="getSortDir('longtitle')"></i>
      </th>
      <th style="width:40px;text-align:center" ng-click="change('rating')">
        Рейтинг<i ng-class="getSortDir('rating')"></i>
      </th>
      <th style="width:40px;text-align:center" ng-click="change('total')">
        Сумма оценок<i ng-class="getSortDir('total')"></i>
      </th>
      <th style="width:40px;text-align:center" ng-click="change('votes')">
        Голоса<i ng-class="getSortDir('votes')"></i>
      </th>
        ...
        <div class="modal-body">
          <table class="table table-striped table-hover table-condensed">
            ...
            <tr ng-repeat="vote in resource.votes">
              ...
              <td>
                <span ng-bind="vote.date"></span>
                в
                <span ng-bind="vote.time"></span>
              </td>

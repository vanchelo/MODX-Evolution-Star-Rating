...
// harden it
require_once dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/manager/includes/protect.inc.php';
...
if ($database_user == '') {
    $rt = include_once dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/manager/includes/config.inc.php';
